...
## 成果截图
![](/blogs/set-jenkins-workday-build/60159388354a01a8.png)

## 总结
  本文介绍了如何通过 Jenkins 的定时任务（Cron 表达式）实现仅在工作日触发自动构建。通过合理配置时间规则，可以避免无效构建，提升 CI 流程的效率与资源利用率。在实际使用中，根据团队的工作节奏灵活调整构建策略，能够让自动化流程更加高效稳定。